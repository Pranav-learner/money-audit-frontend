...
const sheetVariants = cva(
  'fixed z-50 flex flex-col gap-4 bg-card shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
...
function SheetFooter({ className, ...props }: HTMLAttributes<HTMLDivElement>) {
  return <div className={cn('mt-auto flex flex-col gap-2 border-t border-border p-5', className)} {...props} />;
}
